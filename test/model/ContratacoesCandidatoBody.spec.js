...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContratacoesCandidatoBody', function() {
      beforeEach(function() {
        instance = new SistemaApi.ContratacoesCandidatoBody();
      });

      it('should create an instance of ContratacoesCandidatoBody', function() {
        // TODO: update the code to test ContratacoesCandidatoBody
        expect(instance).to.be.a(SistemaApi.ContratacoesCandidatoBody);
      });
