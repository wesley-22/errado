...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1HorariosBody', function() {
      beforeEach(function() {
        instance = new SistemaApi.V1HorariosBody();
      });

      it('should create an instance of V1HorariosBody', function() {
        // TODO: update the code to test V1HorariosBody
        expect(instance).to.be.a(SistemaApi.V1HorariosBody);
      });
