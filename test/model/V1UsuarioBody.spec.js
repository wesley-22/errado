...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('V1UsuarioBody', function() {
      beforeEach(function() {
        instance = new SistemaApi.V1UsuarioBody();
      });

      it('should create an instance of V1UsuarioBody', function() {
        // TODO: update the code to test V1UsuarioBody
        expect(instance).to.be.a(SistemaApi.V1UsuarioBody);
      });
